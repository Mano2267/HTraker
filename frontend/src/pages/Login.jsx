      ...
      >
        ...
        >
          <div className="mb-6 text-center lg:text-left">
            ...
            <h1 className="text-2xl font-semibold text-slate-900">HIA</h1>
            <p className="mt-2 text-sm text-slate-500">Health Insights Agent</p>
          </div>
          ...
          <p className="mt-4 text-center text-sm text-slate-500 lg:text-left">
            No account?{" "}
            <Link className="font-medium text-sky-600 transition hover:text-sky-700" to="/signup">
              Sign up
            </Link>
          </p>
        </motion.form>
